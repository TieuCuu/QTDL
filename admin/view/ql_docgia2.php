        ...
        <li class="nav-item " role="presentation">
            <button class="btn border-primary">
                <a class="nav-link " id="tab-login" data-mdb-toggle="pill" href="index.php?act=qldocgia1" role="tab"
                    aria-controls="pills-login" aria-selected="true">Chưa trả sách</a>
            </button>
        </li>

        <li class="nav-item " role="presentation">
            <button class="btn border-primary">
                <a class="nav-link " id="tab-login" data-mdb-toggle="pill" href="index.php?act=ds_docgia" role="tab"
                    aria-controls="pills-login" aria-selected="false">Danh sách đọc giả</a>
            </button>
        </li>

        <li class="nav-item " role="presentation">
            <button class="btn ">
                <a class="nav-link active" id="tab-register" data-mdb-toggle="pill" href="index.php?act=qldocgia2" role="tab"
